 ...
 *
 * WebCrypto is the fast path; a pure-JS SHA-256 covers insecure origins
 * (e.g. http://lan-ip over a home network) where crypto.subtle is absent.
 */
...
// --- Minimal SHA-256 (standard algorithm, no dependencies) ---
...
function sha256Hex(data: Uint8Array): string {
  ...
  dv.setUint32(padded.length - 4, bitLen % 0x100000000);
